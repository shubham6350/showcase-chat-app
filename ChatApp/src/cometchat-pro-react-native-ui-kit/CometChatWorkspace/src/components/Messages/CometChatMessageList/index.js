...
import StatusReceiverReply from '../CometChatStatusReply/CometChatReceiverStatusReply';
import StatusReply from '../CometChatStatusReply/CometChatStatusReply';
import {
...
class CometChatMessageList extends React.PureComponent {
    ...
    if (Object.prototype.hasOwnProperty.call(message, 'deletedAt')) {
      ...
      switch (message.type) {
        case CometChat.MESSAGE_TYPE.TEXT:
          // console.log(message, '23324234234234');
        ...
        case CometChat.MESSAGE_TYPE.IMAGE:
          ...
          component = message.data?.url ? (
            message.data?.type === 'status-reply' ? (
              <StatusReply messsage={message.data} />
            ) : (
    ...
    if (Object.prototype.hasOwnProperty.call(message, 'deletedAt')) {
      ...
      switch (message.type) {
        ...
        case CometChat.MESSAGE_TYPE.IMAGE:
          component = message.data.url ? (
            message.data?.type === 'status-reply' ? (
              <StatusReceiverReply messsage={message.data} />
            ) : (
  ...
  render() {
    ...
    return (
      <>
        {this.props.pinned_Message != null ? (
          <>
            {this.props.pinned_Message.pinnedMessages[
              this.props.pinned_Message.pinnedMessages.length - 1
            ] != undefined ? (
              <View
                style={{
                  width: '100%',
                  height: 30,
                  backgroundColor: '#3375CA',
