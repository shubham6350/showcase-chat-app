...
import { CometChatUserDetails1 } from '../../Users';
  ...
  actionHandler = (action, messages, key, group, options) => {
    ...
    switch (action) {
      ...
      case actions.CLOSE_DETAIL:
        this.setState({ userDetailVisible: false, groupDetailVisible: false,userDocsVisible: false });
        break;
    ...
    return (
      <CometChatContextProvider ref={(el) => (this.contextProviderRef = el)}>
        <KeyboardAvoidingView
          ...
          style={{ flex: 1 }}>
          <SafeAreaView style={this.state.mobile_theme === 'dark' ? styles_dark.chatWrapperStyle : style.chatWrapperStyle}>
                  {imageView}
