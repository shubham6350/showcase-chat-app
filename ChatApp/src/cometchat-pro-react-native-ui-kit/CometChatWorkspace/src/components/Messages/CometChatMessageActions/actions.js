...
export default (props) => {
  ...
  if (
    ...
    sendMessage = (
      <TouchableOpacity
        ...
        <Text style={scheme === 'dark' ? styles_dark.actionsText : styles.actionsText}>Send Message Privately</Text>
      </TouchableOpacity>
    );
  }
  let threadedChats = (
    <TouchableOpacity
      ...
      <FeatherIcon name="message-circle" size={actionIconSize} />
      <Text style={scheme === 'dark' ? styles_dark.actionsText : styles.actionsText}>Start Thread</Text>
    </TouchableOpacity>
  );
  ...
  let deleteMessage = (
    <TouchableOpacity
      ...
      <Text style={scheme === 'dark' ? styles_dark.actionsText : styles.actionsText}>Delete message</Text>
    </TouchableOpacity>
  );
  ...
  let editMessage = (
    <TouchableOpacity
      ...
      <Text style={scheme === 'dark' ? styles_dark.actionsText : styles.actionsText}>Edit message</Text>
    </TouchableOpacity>
  );
  ...
  return (
    <TouchableWithoutFeedback onPress={() => {}}>
      <View style={scheme === 'dark' ? styles_dark.actionsContainer : styles.actionsContainer}>
        {sendMessage}
        {threadedChats}
        {editMessage}
        {deleteMessage}
