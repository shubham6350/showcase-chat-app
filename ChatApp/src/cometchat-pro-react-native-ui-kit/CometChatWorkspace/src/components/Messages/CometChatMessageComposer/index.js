...
export default class CometChatMessageComposer extends React.PureComponent {
  ...
  render() {
    ...
    let inputVal = (
      <View style={this.state.mobile_theme === 'dark' ?  {height: 50,flexDirection: 'row',alignItems: 'center',marginBottom: 10, backgroundColor: '#181A20'} : {height: 50,flexDirection: 'row',alignItems: 'center',marginBottom: 10, backgroundColor: '#fff'}}>
      <View style={this.state.mobile_theme === 'dark' ? {width: '86%' ,height: 50,backgroundColor: '#23262E', borderRadius: 10, marginRight: 10, flexDirection: 'row',alignItems: 'center',paddingHorizontal: 10, paddingVertical: 15} : {width: '86%' ,height: 50,backgroundColor: '#FAFAFA', borderRadius: 10, marginRight: 10, flexDirection: 'row',alignItems: 'center',paddingHorizontal: 10, paddingVertical: 15}}>
      <TouchableOpacity
        ...
        {this.state.mobile_theme === 'dark' ? <Feather size={20} name="smile" color="#fff" /> : <Feather size={20} name="smile" color="rgba(0,0,0,0.35)" />}
      </TouchableOpacity>
      <TextInput
        style={this.state.mobile_theme === 'dark' ? styles_dark.messageInputStyle : style.messageInputStyle}
        editable={!disabled}
      ...
      <TouchableOpacity
        ...
        {this.state.mobile_theme === 'dark' ? <Entypo size={20} name="attachment" color="#fff" /> : <Entypo size={20} name="attachment" color="rgba(0,0,0,0.35)" />}
      </TouchableOpacity>
      <TouchableOpacity
        style={style.plusCircleContainer}
        disabled={disabled}
        onPress={() => this.takePhoto()}>
        {this.state.mobile_theme === 'dark' ? <Entypo size={20} name="camera" color="#fff" /> : <Entypo size={20} name="camera" color="rgba(0,0,0,0.35)" />}
      </TouchableOpacity>
      </View>
      <View>
      {/* <Text>T</Text> */}
    ...
    return (
      <View
        style={this.state.mobile_theme === 'dark' ?  
