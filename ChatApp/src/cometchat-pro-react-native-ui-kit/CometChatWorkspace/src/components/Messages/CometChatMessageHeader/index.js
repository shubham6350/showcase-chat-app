...
class CometChatMessageHeader extends React.Component {
  ...
  // themee = useContext(themeContext);
  ...
  componentDidMount() {
    console.log(this.props.themec, 'contextcolor');
        ...
        {this.props.LongpressToggle ? (
          <View
            ...
            <View
              ...
              <View style={{ width: '10%', height: 30 }}>
                <TouchableOpacity onPress={() => this.props.pinMessage()}>
                  <Image
                    source={require('../../../../../../../assets/images/pinn.png')}
              ...
              <View style={{ width: '10%', height: 30 }}>
                <TouchableOpacity
                  onPress={() => {
                    this.props.actionGenerated(actions.DELETE_MESSAGE);
                  }}>
                  <Image
