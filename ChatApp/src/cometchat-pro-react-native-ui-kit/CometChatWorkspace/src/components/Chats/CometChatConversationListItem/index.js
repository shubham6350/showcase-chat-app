...
class CometChatConversationListItem extends React.Component {
  ...
  render() {
    ...
    if (this.state.lastMessage) {
      lastMessageTimeStamp = (
        <Text style={this.state.mobile_theme === 'dark' ? styles_dark.itemLastMsgTimeStyle : styles.itemLastMsgTimeStyle} numberOfLines={1}>
    ...
    return (
      <View key={this.props?.conversation?.conversationId}>
        <TouchableOpacity
          ...
          style={this.state.mobile_theme === 'dark' ? styles_dark.listItem : styles.listItem}
          onPress={() =>
          ...
          <View
            ...
            <View
              ...
              <Text numberOfLines={1} style={this.state.mobile_theme === 'dark' ? styles_dark.itemNameStyle : styles.itemNameStyle}>
                {this.props.conversation.conversationWith.name}
              </Text>
              <View style={styles_dark.itemLastMsgStyle}>
                {lastMessageTimeStamp}
              </View>
            </View>
            <View
              ...
              <Text numberOfLines={1} style={this.state.mobile_theme === 'dark' ? styles_dark.itemLastMsgTimeStyle : styles.itemLastMsgTimeStyle}>
