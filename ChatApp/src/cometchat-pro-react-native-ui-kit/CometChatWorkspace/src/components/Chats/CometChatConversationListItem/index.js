...
class CometChatConversationListItem extends React.Component {
  ...
  archivedChat = (conversationType, conversationWith) => {
  ...
  render() {
    ...
    return (
      <View key={this.props?.conversation?.conversationId}>
        <TouchableOpacity
          activeOpacity={1}
          underlayColor={{ backgroundColor: this.props.theme.background }}
          style={[
            styles.listItem,
          ...
          onLongPress={() => {
            this.archivedChat(
              this.props.conversation.conversationType,
              this.props.conversation.conversationWith.uid,
            );
            // console.log(this.props.conversation.conversationWith,'======');
            // Alert.alert('ohk');
          }}>
          <View style={styles.itemThumbnailStyle}>
            <CometChatAvatar
              ...
              cornerRadius={45}
              borderColor={{ backgroundColor: this.props.theme.background }}
              borderWidth={0}
