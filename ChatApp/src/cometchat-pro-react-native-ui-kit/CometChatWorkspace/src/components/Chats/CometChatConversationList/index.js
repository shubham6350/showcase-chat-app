...
class CometChatConversationList extends React.Component {
  ...
  componentDidMount() {
    ...
    let mobile_theme = Appearance.getColorScheme();
    this.setState({mobile_theme});
  ...
  checkRestrictions = async () => {
    ...
    this.setState({ isMessagesSoundEnabled , themee: Appearance.getColorScheme() });
  };
      ...
      <View style={styles.contactMsgStyle}>
        ...
        <View
          ...
          <View
            ...
            <Text style={{ fontSize: 40, color: '#246BFD', fontWeight: '700' }}>
              Welcome! 👋
            </Text>
          </View>
        </View>
  ...
  render() {
    return (
      <CometChatContextProvider ref={(el) => (this.contextProviderRef = el)}>
        ...
        <SafeAreaView style={this.state.themee = 'dark' ? { backgroundColor: '#000' } : { backgroundColor: '#fff' }}>
          <KeyboardAvoidingView
            behavior={Platform.OS === 'ios' ? 'padding' : 'height'}
            style={this.state.mobile_theme === 'dark' ? styles_dark.conversationWrapperStyle : styles.conversationWrapperStyle}>
          ...
          {this.state.messageCount ? 
             ...
             <View style={this.state.mobile_theme === 'dark' ? {flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#000'} : {flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff'}}>
          ...
          <KeyboardAvoidingView
            ...
            <View style={styles.headerContainer}></View>
            <View style={this.state.mobile_theme === 'dark' ? styles_dark.contactMsgStyle : styles.contactMsgStyle}>
        <View
          style={{
            // backgroundColor: 'yellow',
            flex: 1,
        ...
        <View
          ...
          <View style={{ width: '80%', alignItems: 'center' , marginTop: 10 }}>
            <Text style={this.state.mobile_theme === 'dark' ? { fontWeight: '500',fontFamily: 'Urbanist-Medium' ,justifyContent: 'center', color: '#fff'} : { fontWeight: '500',fontFamily: 'Urbanist-Medium' ,justifyContent: 'center', color: '#000'}}>
              Hi chat connects you with family and friends.
            </Text>
          </View>
        </View>
        <View
          ...
          <View
            ...
            <Text style={this.state.mobile_theme === 'dark' ? { fontWeight: '500',fontFamily: 'Urbanist-Bold', color: '#fff'  } : { fontWeight: '500',fontFamily: 'Urbanist-Bold', color: '#000'  }}>Start chatting now!</Text>
          </View>
        </View>
