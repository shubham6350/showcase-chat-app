...
class CometChatConversationList extends React.Component {
  ...
  componentDidMount() {
    ...
    // console.log(this.context, '444444$$$$$$$$$$');
  ...
  checkRestrictions = async () => {
    ...
    this.setState({
      ...
      themee: Appearance.getColorScheme(),
    });
  };
  ...
  render() {
    // console.log(this.state.conversationList, '++++___+++++');
    return (
      <CometChatContextProvider ref={(el) => (this.contextProviderRef = el)}>
        {this.state.conversationList.length > 0 ? (
          <SafeAreaView
            style={{ backgroundColor: this.props.themec.background }}>
            <KeyboardAvoidingView
