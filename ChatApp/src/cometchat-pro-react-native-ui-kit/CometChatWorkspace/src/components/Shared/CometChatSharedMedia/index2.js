...
export default class CometChatSharedMedia1 extends React.Component {
      ...
      <View style={[styles.sectionStyle, {}]}>
        ...
        { videoView ?
          <CometChatVideoViewer
            ...
            message={activeMessage}
          /> : null}
          {/* <TouchableOpacity onPress={() => this.props.navigation.navigate('CometChatUserDoc')}>
          <View style={{flexDirection: 'row',justifyContent: 'center',alignItems: 'center'}}>
          <Image source={require('../../../../../../../assets/images/mldb.png')} style={{width: 30,height: 30}}/>
          <Text
          style={[
        ...
        <Icon3 name="right" size={20} color="#000" style={{ marginRight: 5 }} />
        </View>
        </TouchableOpacity> */}
        <View style={[styles.sectionContentStyle]}>
          <View style={{paddingHorizontal: 15,backgroundColor: '#246BFD',marginTop: -15}}>
          <View style={styles.mediaBtnStyles}>
            <TouchableOpacity
              onPress={() =>
              ...
              <Text style={styles.buttonTextStyles}>Photos</Text>
            </TouchableOpacity>
            {messageType === CometChat.MESSAGE_TYPE.FILE ? (
            ...
            <TouchableOpacity
              ...
              <Text style={styles.buttonTextStyles}>Videos</Text>
            </TouchableOpacity>
            {messageType === CometChat.MESSAGE_TYPE.IMAGE ? (
              <View style={styles.separator} />
            ) : null}
            <TouchableOpacity
              ...
              <Text style={styles.buttonTextStyles}>Documents</Text>
            </TouchableOpacity>
          </View>
          </View>
          <FlatList
