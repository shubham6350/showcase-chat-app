...
export default class CometChatGroupDetails extends React.Component {
  ...
  componentDidMount() {
    ...
    var e = new Date(this.props.item.createdAt * 1000).toLocaleString();
    this.setState({ dateCreated: e });
  ...
  render() {
      ...
      <TouchableOpacity
        ...
        <View
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            {this.props.themec.theme === 'dark' ? (
              <Image
                source={require('../../../../../../../assets/images/membersd.png')}
            ...
            <Text
              style={[
                style.itemLinkStyle,
                { color: this.props.themec.color, paddingLeft: 5 },
              ]}>
              View members
            </Text>
          </View>
      ...
      deleteGroupBtn = (
        <TouchableOpacity
          ...
          <View
            ...
            <Image
              source={require('../../../../../../../assets/images/exitg.png')}
              style={{ width: 30, height: 30, marginRight: 10 }}
            />
            <Text
              style={[
                style.itemLinkStyle,
                { color: this.viewTheme.color.red, paddingLeft: 5 },
              ]}>
              Exit Group
            </Text>
          </View>
    ...
    return (
      <SafeAreaView style={style.modalWrapper}>
        <Modal
          transparent
          animated
          animationType="fade"
              ...
              renderContent={() => {
                return (
                  <TouchableHighlight>
                    <SafeAreaView
                      style={[
                        style.reactionDetailsContainer,
                        { backgroundColor: this.props.themec.background },
                      ]}>
                      <GroupDetailContext.Provider
                        ...
                        <View
                          ...
                          <View style={styles.groupDetail}>
                            ...
                            <Text
                              ...
                              numberOfLines={1}>
                              Group | {parseInt(this.props.item?.membersCount)}{' '}
                              participants
                            </Text>
                          </View>
                        </View>
                        ...
                        <View
                          ...
                          {this.state.administratorsList[0] != null ? (
                            <>
                              <Text
                                style={[
                                  {
                              ...
                              <Text
                                ...
                                Created by{' '}
                                {this.state.administratorsList[0].name},{' '}
                        ...
                        <View
                          ...
                          <TouchableOpacity
                            onPress={() =>
                              this.props.actionGenerated(actions.VIEW_DOCS)
                            }>
                            <View
                              style={{
                                flexDirection: 'row',
                              ...
                              <View
                                ...
                                {this.props.themec.theme === 'dark' ? (
                                  <Image
                                    source={require('../../../../../../../assets/images/mld.png')}
                                    style={{ width: 30, height: 30 }}
                                  />
                                ) : (
                                  <Image
                                    source={require('../../../../../../../assets/images/mldb.png')}
                                    style={{ width: 30, height: 30 }}
                                  />
                                )}
                                <Text
                          ...
                          <TouchableOpacity
                            ...
                            <View
                              ...
                              <View
                                ...
                                {this.props.themec.theme === 'dark' ? (
                                  <Image
                                    source={require('../../../../../../../assets/images/Starstard.png')}
                                    style={{ width: 30, height: 30 }}
                                  />
                                ) : (
                                  <Image
                                    source={require('../../../../../../../assets/images/Starstar.png')}
                                    style={{ width: 30, height: 30 }}
                                  />
                                )}
                                <Text
