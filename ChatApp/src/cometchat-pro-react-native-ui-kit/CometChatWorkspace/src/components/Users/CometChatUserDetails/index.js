...
import CometChatUserDetails1 from './index2';
                ...
                <TouchableHighlight>
                  <View style={style.reactionDetailsContainer}>
                    ...
                    <View style={style.optionsContainer}>
                      {action}
                    <TouchableOpacity onPress={() => this.props.actionGenerated(actions.VIEW_DOCS)}>
                    <View style={{flexDirection: 'row',alignItems: 'center',width: '84%'}}>
                    ...
                    <Icon3 name="right" size={18} color="black" />
                    </View>
                    </TouchableOpacity>
                    {blockUserView}
                      {/* {sharedMediaView} */}
