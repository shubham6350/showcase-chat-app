...
class CometChatUserSearch extends React.PureComponent {
  ...
  renderUserView = ({ item, index }) => {
    if (item.header) {
      ...
      //   <View
      //     style={
      //       (style.contactAlphabetStyle, { color: this.props.themee.color })
      //     }
      //     key={index}>
      //     <Text style={[style.contactAlphabetTextStyle,{ color: this.props.themee.color }]}>{headerLetter}</Text>
      //   </View>
      // );
      return null;
    }
                ...
                <View
                  ...
                  <TouchableWithoutFeedback
                    ...
                    <View
                      ...
                      />
                      <TouchableOpacity
                        onPress={() => this.setState({ textInputValue: '' })}>
                        <Icon
                          name="close"
                          size={20}
                          color={this.props.themee.color}
...
export default CometChatUserSearch;
