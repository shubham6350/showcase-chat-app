...
import CometChatSharedMedia1 from '../../Shared/CometChatSharedMedia/index2';

export default class CometChatUserDetails1 extends React.Component {
              ...
              return (
                <TouchableHighlight>
                  <SafeAreaView
                    ...
                    <View style={style.optionsContainer1}>
                      <CometChatSharedMedia1
                        theme={this.props.theme}
                        themec={this.props.themec}
                        containerHeight={50}
                        navigation={this.props.navigation}
                        showMessage={(type, message) => {
                          this.dropDownAlertRef?.showMessage(type, message);
