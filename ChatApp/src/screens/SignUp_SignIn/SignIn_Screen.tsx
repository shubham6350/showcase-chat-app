    ...
    <SafeAreaView style={scheme === 'dark' ? Styles_dark.mainContainer : Styles.mainContainer}>
      <View style={Styles.icon_container}>
        <TouchableOpacity onPress={() => navigation.navigate('Welcome_Screen')}>
          <Antdesign name="arrowleft" color={scheme === 'dark' ? '#fff' : '#000'} size={20} />
        </TouchableOpacity>
      </View>
      <View style={Styles.Image_Container}>
        <View style={Styles.Image_Box}>
          ...
          <Image
            style={{ height: 170, width: 200 }}
            source={require('../../../assets/images/FrameBanner_dark.png')}
          /> : 
          <Image
          style={{ height: 170, width: 200 }}
          source={require('../../../assets/images/Framebanner.png')}
      ...
      <View style={Styles.Heading}>
        <View style={Styles.Heading_text_Box}>
          <Text style={scheme === 'dark' ? Styles_dark.Heading_text : Styles.Heading_text}>Let's you in</Text>
        </View>
      </View>
