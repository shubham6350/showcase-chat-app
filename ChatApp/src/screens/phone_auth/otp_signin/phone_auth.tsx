      ...
      style={{flex: 1}}
         >
            ...
            <View style={styles.heads1}>
                <Text style={styles.head1}>Login to Your Account</Text>
            </View>
            ...
            <View style={styles.bott}>
                <Text style={styles.bottxt}>Don't have an account? <Text style={{color: '#246BFD'}} onPress={() => navigation.navigate('SignUp')}>Sign up</Text></Text>
            </View>
            </View>
            </KeyboardAvoidingView>
        </SafeAreaView>
